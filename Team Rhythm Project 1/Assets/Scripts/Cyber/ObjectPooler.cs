...
public class ObjectPooler : MonoBehaviour {
  ...
  // This searches for an inactive object in the pool that can be used. This is called in another script when needed.
  public GameObject GetPooledObject(string tag)
  {
    ...
    // This checks if the object pool needs to expand and if it does adds another object to the pool and expands the pool
    foreach (ObjectPoolItem item in itemsToPool)
    {
